...
A typed zero-dependency Node.js static file / REST routing server with support for clustering, TLS, HTTP caching, range requests, gzip, middleware, and Chrome DevTools workspace integration.
